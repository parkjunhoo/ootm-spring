...
public class MemberDTO {
	...
	private Timestamp member_regString; // default = now();
	...
	public MemberDTO(String member_id, String member_name, String member_email, String member_password,
			String member_birth, String member_zipcode, String member_address, String member_telnum, String member_opt,
			String member_status, Timestamp member_regString, String member_grade, int member_point) {
		super();
		...
		this.member_regString = member_regString;
	...
	// 회원가입 insert용
	public MemberDTO(String member_id, String member_name, String member_email, String member_password,
			String member_birth, String member_zipcode, String member_address, String member_telnum,
			String member_opt) {
		super();
		this.member_id = member_id;
		this.member_name = member_name;
	...
	public Timestamp getMember_regString() {
		return member_regString;
	}

	public void setMember_regString(Timestamp member_regString) {
		this.member_regString = member_regString;
	}
