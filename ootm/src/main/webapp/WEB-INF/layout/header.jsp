...
<body>
	<header>
		...
		<div <%if(bgColor != null){%>style="background-color:<%=bgColor %>;"<%}%> id="headerNav">
			<div <%if(bgHoverColor != null){%>style="background-color:<%=bgHoverColor %>;"<%}%> id="headerMenuBackground"></div>
			...
			<div id="headerNavTextMenu">
				<ul class="menuList dropListHeader">
					...
					<li>
						<div>
							<div>
								<p style="color:<%=mTextColor %>; "><%=hmd.getName()%></p>
			...
			<%if(mTextColor!=null){%>style="fill:<%=mTextColor %>;" <%} %>
			>
				<svg onclick="location.href='<%=loginHref%>'" id="headerMemeberBtn" width="48" height="48"
				...
				<svg onclick="location.href='/basket'" id="headerBasketBtn" width="48" height="48"
					viewBox="0 96 960 960">
					<path
			...
			<div id="headerNavMenuBtn">
				<div <%if(menuBtnColor!=null){%>style="background-color:<%=menuBtnColor %>;" <%}%> class="headerMenuBtnIcon"></div>
				<div <%if(menuBtnColor!=null){%>style="background-color:<%=menuBtnColor %>;" <%}%> class="headerMenuBtnIcon"></div>
			</div>
		</div>
		<div id="drawer"></div>
