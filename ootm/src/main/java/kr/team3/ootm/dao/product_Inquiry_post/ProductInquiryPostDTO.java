...
public class ProductInquiryPostDTO {
	...
	// insert용
	public ProductInquiryPostDTO(int product_id,String member_id ,String inquiry_post_title,String inquiry_post_content) {
	...
	// select read 용
	public ProductInquiryPostDTO(int inquiry_post_id, int product_id, String member_id, String inquiry_post_title,
