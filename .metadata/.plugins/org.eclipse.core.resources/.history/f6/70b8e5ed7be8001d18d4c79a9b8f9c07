...
public class InquiryPostDTO {
	...
	//insert용
	public InquiryPostDTO(String inquiry_post_title,String inquiry_post_content, String inquiry_post_author,
	...
	//select read 용
	public InquiryPostDTO(int inquiry_post_id, String inquiry_post_title,String inquiry_post_content, String inquiry_post_author,
