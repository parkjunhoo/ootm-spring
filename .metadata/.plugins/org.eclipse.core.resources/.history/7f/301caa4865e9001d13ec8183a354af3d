...
public class ProductPageController {
	...
	public ModelAndView productJean() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.JEAN.getValue(),
				0, 30);
	...
	public ModelAndView productPants() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.PANTS.getValue(),
				0, 30);
	...
	public ModelAndView productShortguys() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.SHORT_GUYS.getValue(),
				0, 30);
	...
	public ModelAndView productShoes() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.SHOES.getValue(),
				0, 30);
	...
	public ModelAndView productBag() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.BAG.getValue(),
				0, 30);
	...
	public ModelAndView productAcc() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.ACCESSORY.getValue(),
				0, 30);
	...
	public ModelAndView productSuit() {
		...
		List<ProductDTO> list = service.selectBySubCategoryOrderByBestLimit(ProductSubCategory.SUIT.getValue(),
				0, 30);
